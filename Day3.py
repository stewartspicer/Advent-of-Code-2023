...
in_string = """.479........155..............944.....622..............31.........264.......................532..........................254.........528.....
..............-...............%.....+...................=....111*.................495.......+.......558..................../..........*.....
...
#Used this to get the list of symbols used
# chars_seen = []
# for char in in_string:
#     if char not in chars_seen and not char.isnumeric() and char != ".":
...
sample_input_strings = in_string.split("\n")
sample_input = sample_input_strings

#Get all of the adjacent cells to the given cell, including diagonally
def get_neighbors(array, x, y):
    neighbors = []
    for x_factor in [-1, 0, 1]:
        if x + x_factor < 0:
            continue
        if x + x_factor > len(array[y]) - 1:
            continue
        for y_factor in [-1, 0, 1]:
            if y + y_factor < 0:
                continue
            if y + y_factor > len(array) - 1:
                continue

            if x_factor == 0 and y_factor == 0:
                continue
            neighbors.append(array[y + y_factor][x + x_factor])
    return neighbors

#Checks to see if any of the neighbors are special characters
...
#Check to see if the current number has a neighbor that is a special character
def check_number(cn, x_coord_in, y_coord_in):
    x_coord_min = max(x_coord_in - len(cn), 0)
    for x_coord in range(x_coord_min, x_coord_in):
        neighbors = get_neighbors(sample_input, x_coord, y_coord_in)
        # If any neighbor has a special character, add the part number to the array
        if check_neighbors(neighbors):
            return True
    return False
...
#Sample each row, keeping track of consecutive numeric characters found
for y, row in enumerate(sample_input):
    current_number = ""
    is_valid = False
    for x, character in enumerate(row):
        if character.isnumeric():
            ...
            if x == len(row) -1 and check_number(current_number, x, y):
                part_numbers.append(int(current_number))
        elif character == "." or character in symbols:
            #If we haven't found a digit, do nothing
            if current_number == "":
                continue
            #Otherwise, check all the characters' locations for symbol neighbors
            if check_number(current_number, x, y):
                part_numbers.append(int(current_number))
            #Clear current_number regardless
            current_number = ""

print("Part numbers: " + str(part_numbers))
print("Sum: " + str(sum(part_numbers)))
